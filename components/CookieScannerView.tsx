...
const cookieScanSteps = [
    { message: 'Initializing secure scanner...', progress: 10 },
    { message: 'Requesting primary page...', progress: 20 },
    { message: 'Crawling website for additional pages...', progress: 35 },
    { message: 'Analyzing pre-consent technologies...', progress: 50 },
    { message: 'Simulating consent rejection...', progress: 65 },
    { message: 'Analyzing post-rejection state...', progress: 80 },
...
export const CookieScannerView: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="mt-12">
        {isLoading && <ScanningProgress steps={cookieScanSteps} />}
        {error && (
